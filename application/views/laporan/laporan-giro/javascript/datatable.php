            ...
            drawCallback : function ( settings ) {
                ...
                api.column(0, {page:'current'} ).data().each( function ( group, i ) {
                    if ( last !== group ) {
                        ...
                        $(rows).eq( i ).before(
                            '	<tr class="tr-collapse" data-target="'+ group +'" style="cursor:pointer;"><td>'+  group +'</td><td class="text-center"><a class="dropdown-item" href="<?= $module['url'];?>/single/'+ data.awal +'/'+data.akhir+'/'+id_cabang+'">Detail</a><td><tr>'
                            // '<td>'+data.awal+'</td></tr>'
                        );
