	...
	$(document).ready(function(){
		const dt = $('#dt').DataTable({
			...
			columns 		: [
				...
				// { data : 'nomor_pembelian' },
				{ data : 'nominal', width: '140px', className:'text-right', render : $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'metode', width: '100px', className:'text-center'},
				{ 
					data : 'id', 
					className : 'text-center', 
					width: '40px', 
