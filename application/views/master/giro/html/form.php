						...
						<div class="form-group form-row align-items-center">
							...
							<div class="col-md-4">
								<select class="form-control" name="cabang[jenis]" required="required">
									<option value="Penjualan" <?= isset($data->jenis) && $data->jenis == 'Penjualan' ? 'selected="selected"' : NULL;?>>Penjualan</option>
									<option value="Pembelian" <?= isset($data->jenis) && $data->jenis == 'Pembelian' ? 'selected="selected"' : NULL;?>>Pembelian</option>
								</select>
							</div>
						</div>						
						<div class="form-group form-row align-items-center">
