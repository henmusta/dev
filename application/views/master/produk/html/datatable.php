    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                ...
                <form id="barcode_multiple" action="<?= isset($module['action']) ? $module['action'] : NULL; ?>"
                    method="POST" target="dummyframe">
                    <div class="block-header">
                        <div class="block-options">
                            <h3 class="block-title">Data <?= $module['name']; ?></h3>
                        </div>
                        <button class="btn btn-outline-success" style="text-align:center;">Cetak Barcode
                            Multiple</button>
                        <div class="col-md-4">
                        ...
                        <div class="block-options">
                            ...
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="<?= $module['url']; ?>/insert" class="btn btn-outline-primary"><i
