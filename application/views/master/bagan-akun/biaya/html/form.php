			...
			<form id="form" method="POST" action="<?= isset($module['action']) ? $module['action'] : NULL ;?>" autocomplete="off">
				...
				<div class="block">
					...
					<div class="block-content">
						...
						<div class="form-group form-row align-items-center">
									<label class="col-md-3 text-right">Biaya</label>
									<div class="col-md-9">
										<select id="select2-biaya" class="form-control" name="akun[kelompok]" required="required">
											<option> </option>
											<option value='Biaya_lampung'> Biaya Lampung  </option>
  											<option value='Biaya_jakarta'> Biaya Jakarta </option>
										</select>
									</div>
								</div>				
					</div>
