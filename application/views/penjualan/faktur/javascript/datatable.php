	...
	$(document).ready(function(){
		...
		const dt = $('#dt').DataTable({
			...
			columns 		: [
				...
				{ data : 'notaretur', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'chek', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'bayar', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'rppotongan', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'total_tagihan', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
				{ data : 'total_pelunasan', className:'text-right', width:'180px', render: $.fn.dataTable.render.number( ',', '.', 0, '' ) },
