...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
            ...
            emptyClass      : 'dd-empty',
            expandBtnHTML   : '<button class="btn btn-sm btn-outline-secondary" data-action="expand" type="button"><i class="fa fa-fw fa-angle-down"></i></button>',
            collapseBtnHTML : '<button class="btn btn-sm btn-outline-secondary" data-action="collapse" type="button"><i class="fa fa-fw fa-angle-up"></i></button>',
            group           : 0,
            maxDepth        : 5,
            threshold       : 20,
            /* callback */
    ...
    Plugin.prototype = {
        ...
        setParent: function(li)
        {
            if (li.children(this.options.listNodeName).length) {
                li.children('.dd-content').after($(this.options.expandBtnHTML));
                li.children('.dd-content').after($(this.options.collapseBtnHTML));
            }
            li.children('[data-action="expand"]').hide();
        },
